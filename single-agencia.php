	...
	<main id="primary" class="site-main site-container">
		...
		while ( have_posts() ) :
			...
			<div class="container mx-auto">
				...
				<div class="flex columns-agencia">
					<div class="column-1 mr-10 flex flex-col border border-gray-light p-4 pr-10">
						...
						<div class="mb-5">
							...
							<div><a target="_blank" href="https://www.google.com/maps/dir/?api=1&destination=<?php echo esc_attr($location['lat']); ?>,<?php echo esc_attr($location['lng']); ?>" class="items-center flex text-sm font-semibold text-blue-dark">Cómo llegar <svg xmlns="http://www.w3.org/2000/svg" width="15" height="15" viewBox="0 0 48 48"><path d="M20 12l-2.83 2.83 9.17 9.17-9.17 9.17 2.83 2.83 12-12z" fill="#005098" /><path d="M0 0h48v48h-48z" fill="none"/></svg></a></div>
						</div>
						...
						<div class="mt-2">
							<div class="mb-2 pb-1 border-b border-gray-light <?php if(date('w') == 1 ) { echo "text-blue-dark font-bold";} ?>">Lunes: <?php the_field('lunes') ?></div>
							<div class="mb-2 pb-1 border-b border-gray-light <?php if(date('w') == 2 ) { echo "text-blue-dark font-bold";} ?>">Martes: <?php the_field('martes') ?></div>
							<div class="mb-2 pb-1 border-b border-gray-light <?php if(date('w') == 3 ) { echo "text-green font-bold";} ?>">Miércoles: <?php the_field('miercoles') ?></div>
							<div class="mb-2 pb-1 border-b border-gray-light <?php if(date('w') == 4 ) { echo "text-blue-dark font-bold";} ?>">Jueves: <?php the_field('jueves') ?></div>
							<div class="mb-2 pb-1 border-b border-gray-light <?php if(date('w') == 5 ) { echo "text-blue-dark font-bold";} ?>">Viernes: <?php the_field('viernes') ?></div>
							<div class="mb-2 pb-1 border-b border-gray-light <?php if(date('w') == 6 ) { echo "text-blue-dark font-bold";} ?>">Sábado: <?php the_field('sabado') ?></div>
							<div class="mb-2 pb-1 border-b border-gray-light <?php if(date('w') == 7 ) { echo "text-blue-dark font-bold";} ?>">Domingo: <?php the_field('domingo') ?></div>
						</div>
				...
				<?php if(get_field('bloque_promociones') == 1) { ?>
