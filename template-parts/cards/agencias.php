<div class="flex flex-col border border-gray-light p-4 pr-10 mb-2 mr-2">
	...
	<div class="mt-2 flex"><a href="<?php the_permalink(); ?>" class="border-2 border-blue-dark bg-blue-dark text-white font-medium py-1 px-4">Ver agencia</a><a href="https://www.google.com/maps/dir/?api=1&destination=<?php echo esc_attr(get_field('direccion')['lat']); ?>,<?php echo esc_attr(get_field('direccion')['lng']); ?>" target="_blank" class="border border-2 border-black text-black font-medium py-1 px-4 ml-3">Cómo llegar</a></div>
</div>