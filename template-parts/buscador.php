<div class="mx-auto mb-10 max-w-2xl">
	<div class="md:flex">
		<form action="" class="w-full flex mr-5 buscador">
			<select name="search" id="search-agencias" class="w-full border border-gray-light px-5 py-2 outline-none mb-5 md:mb-0">
				<option value=""></option>
			</select>
