...
// from https://github.com/demirdoven/image-gallery-for-cpt-or-post-in-wordpress
...
function property_gallery_save( $post_id ) {
		...
		// Correct post type
		if ( 'agencia' != $_POST['post_type'] ) // here you can set the post type name
			return;
